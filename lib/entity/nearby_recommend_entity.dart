...
part 'nearby_recommend_entity.g.dart';

@JsonSerializable()
class NearbyRecommendEntity extends Object {
  @JsonKey(name: 'count')
  int count;
  ...
  List<DataNearby> getData() {
    return data == null ? new List() : data;
  }

  NearbyRecommendEntity(
    this.count,
    this.ctPoi,
    this.data,
    this.ctPois,
  ...
  factory NearbyRecommendEntity.fromJson(Map<String, dynamic> srcJson) =>
      _$NearbyRecommendEntityFromJson(srcJson);

  Map<String, dynamic> toJson() => _$NearbyRecommendEntityToJson(this);
}

@JsonSerializable()
class DataNearby extends Object {
  @JsonKey(name: 'phone')
  String phone;
  ...
  List<PayAbstracts> getPayAbstracts() {
   return payAbstracts == null ? List() : payAbstracts;
  }
  ...
  DataNearby(
    this.phone,
    this.latestWeekCoupon,
    this.payInfo,
    this.cityId,
    this.location,
    this.addr,
    this.ktvAppointStatus,
    this.brandName,
    this.brandId,
    this.isSuperVoucher,
    this.poiid,
  ...
  factory DataNearby.fromJson(Map<String, dynamic> srcJson) =>
      _$DataNearbyFromJson(srcJson);

  Map<String, dynamic> toJson() => _$DataNearbyToJson(this);
}
...
class PayInfo extends Object {
  ...
  factory PayInfo.fromJson(Map<String, dynamic> srcJson) =>
      _$PayInfoFromJson(srcJson);
...
class PayAbstracts extends Object {
  ...
  factory PayAbstracts.fromJson(Map<String, dynamic> srcJson) =>
      _$PayAbstractsFromJson(srcJson);
...
class Abstracts extends Object {
  ...
  factory Abstracts.fromJson(Map<String, dynamic> srcJson) =>
      _$AbstractsFromJson(srcJson);
...
class Tour extends Object {
  ...
  Tour(
    ...
    this.tourDetailDesc,
    this.tourOpenTime,
    this.tourMarketPrice,
    this.tourPlaceStar,
  );

  factory Tour.fromJson(Map<String, dynamic> srcJson) =>
      _$TourFromJson(srcJson);
...
class Ct_pois extends Object {
  ...
  factory Ct_pois.fromJson(Map<String, dynamic> srcJson) =>
      _$Ct_poisFromJson(srcJson);
