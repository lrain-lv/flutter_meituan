...
RecommendEntity _$RecommendEntityFromJson(Map<String, dynamic> json) {
  return RecommendEntity(
      json['count'] as int,
      json['ct_poi'] as String,
      (json['data'] as List)
          ?.map((e) =>
              e == null ? null : Data2.fromJson(e as Map<String, dynamic>))
          ?.toList(),
...
Map<String, dynamic> _$RecommendEntityToJson(RecommendEntity instance) =>
    <String, dynamic>{
